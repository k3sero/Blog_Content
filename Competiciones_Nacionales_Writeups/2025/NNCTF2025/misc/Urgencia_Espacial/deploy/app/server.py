...
FLAG = (
    b"Beeep beep bep... Sabemos que NavajaNegra2025 acaba de comenzar. "
    b"Por motivos obvios, nuestro equipo no podra asistir en esta edicion. "
    b"De todas formas, queremos enviaros un regalo muy espacial: "
    b"nnctf{M4nd4dn0s_Un_p4r_d3_M1gu3l1tOs_3n_l4_Pr0x1ma_M1sioN!!}"
)
